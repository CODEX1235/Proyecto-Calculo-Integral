from sympy import symbols, sympify, integrate, latex, simplify, expand, pretty, SympifyError, oo
...
def calcular_integral_indefinida(expresion_str: str) -> dict:
    ...
    try:
        ...
        # expand para mostrar forma polinomial, no factorizada
        resultado_final = expand(resultado)

        return {
            "exito": True,
            "resultado": resultado_final,
            "latex": latex(resultado_final) + " + C",
            "texto": str(resultado_final) + " + C",
            "pretty": pretty(resultado_final, use_unicode=True) + " + C",
...
def calcular_integral_definida(expresion_str: str, limite_inf, limite_sup) -> dict:
    ...
    try:
        ...
        try:
            valor_numerico = float(resultado_simplificado.evalf())
        except Exception:
            valor_numerico = None
